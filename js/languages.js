...
class LangList {
    constructor() {
        ...
        this.ro_ro = { text: "Romanian / Română", icon: this.ico + "romania.png",
            primary: this.w3 + "glowonline.org/glow-roman", alternate: this.w3 + "sperantatv.ro/",
            check: "glow" };
        this.uk_uk = { text: "Ukrainian / Українська", icon: this.ico + "ukraine.png",
            primary: this.https + "tv.hope.ua", alternate: this.w3 + "glowonline.org/gyd/ukrainian",
            check: "hope" };
        this.ne_nl = { text: "Dutch / Nederlands", icon: this.ico + "netherlands.png",
            primary: this.w3 + "glowonline.org/glow-dutch", alternate: this.https + "hopechannel.dk",
            check: "glow" };
        this.cz_cs = { text: "Czech / Čeština", icon: this.ico + "czech.png",
            primary: this.w3 + "glowonline.org/czech", alternate: this.hope + "cz",
            check: "glow" };
        this.hu_hu = { text: "Hungarian / Magyar", icon: this.ico + "hungary.png",
            primary: this.w3 + "glowonline.org/hungary", alternate: this.https + "remenytv.hu",
            check: "glow" };
        this.sl_sl = { text: "Slovenian / Slovenščina", icon: this.ico + "slovenia.png",
            primary: this.w3 + "glowonline.org/glow-slovensk", alternate: null,
            check: "glow" };
        this.ar_hy = { text: "Armenian / Հայերեն", icon: this.ico + "armenia.png",
            primary: this.w3 + "glowonline.org/glow-armenian", alternate: this.egw + "11414.89&index=0",
            check: "glow" };
        this.no_no = { text: "Norwegian / Norsk", icon: this.ico + "norway.png",
            primary: this.w3 + "glowonline.org/norwegian/", alternate: this.https + "hopechannel.no",
            check: "glow" };
        this.po_pl = { text: "Polish / Polski", icon: this.ico + "poland.png",
            primary: this.w3 + "glowonline.org/pl", alternate: this.https + "hopechannel.pl",
            check: "glow" };
        this.it_it = { text: "Italian / Italiano", icon: this.ico + "italy.png",
            primary: this.https + "hopemedia.it", alternate: this.amazing + "it/casa",
            check: "hope" };
        this.sl_sk = { text: "Slovak / Slovenčina", icon: this.ico + "slovakia.png",
            primary: this.w3 + "glowonline.org/glow-slovak", alternate: null,
            check: "glow" };
        this.sw_sv = { text: "Swedish / Svenska", icon: this.ico + "sweden.webp",
            primary: this.amazing + "sv/hem", alternate: null,
            check: "amazing" };
        this.ic_is = { text: "Icelandic / Íslenska", icon: this.ico + "iceland.webp",
            primary: this.https + "hopechannel.is", alternate: null,
            check: "hope" };
        this.fi_fi = { text: "Finnish / Suomi", icon: this.ico + "finland.webp",
            primary: this.https + "hopechannel.fi", alternate: null,
            check: "hope" };
        this.bu_bg = { text: "Bulgarian / Български", icon: this.ico + "bulgaria.webp",
            primary: this.hope + "bg", alternate: null,
            check: "hope" };
        this.es_et = { text: "Estonian / Eesti", icon: this.ico + "estonia.webp",
            primary: this.yt + "ZEr7IMVNuJ-E-RH-shSlCrp2snoBpsHH", alternate: null,
            check: "youtube" };
        this.ab_ab = { text: "Abkhazian / Аҧсшәа", icon: this.ico + "abkhazia.webp",
            primary: this.egw + "13987.2&index=0", alternate: null,
            check: "egw" };
        this.al_sq = { text: "Albanian / Shqip", icon: this.ico + "albania.webp",
        ...
        this.ph_ceb = { text: "Cebuano / Cebuano", icon: this.ph_tl.icon,
            ...
            check: "hope" };
        this.in_hi = { text: "Hindi / हिन्दी", icon: this.ico + "india.png",
